# Spec: long-buy-persistence

## Purpose

Persist LONG-BUY positions from completed pipeline runs into the `long-buy-history` Modal Dict so they can later be surfaced by the wins endpoint.
