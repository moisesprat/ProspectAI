# Spec: Stats Performance KPIs

## Purpose
The Performance tab on `stats.html` displays four headline KPI cards (Win Rate, Avg Return, Best Pick, Worst Pick) computed client-side from the long-buy history data, giving users an at-a-glance summary above the full track record table.
