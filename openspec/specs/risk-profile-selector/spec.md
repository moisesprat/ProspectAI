# risk-profile-selector Specification

## Purpose
Allows callers to select a risk appetite profile (`conservative` or `aggressive`) that governs allocation caps and stop/take-profit formulas throughout the pipeline.
