# Spec: wins-ticker-marquee

## Purpose

Defines the behaviour of the recent-wins live strip: a continuously scrolling marquee carousel that displays winning trade cards, with accessibility and visual polish requirements.
